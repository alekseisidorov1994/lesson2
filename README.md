...
### Цепной стиль
***
Цепной стиль обеспечивается с помощью `retrun: this`, если в классе каждый в конце каждого метода будет `retrun: this`, то мы сможем по цепочке использовать методы.
